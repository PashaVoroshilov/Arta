...
function lang() {
	return gulp
		.src(paths.src + 'languages/*.json')
		.pipe(gulp.dest(paths.build + 'languages/'))
}
...
function images() {
	return gulp
		.src(paths.src + 'img/**/*.{jpg,jpeg,png,gif,svg,webp}')
...
function watcher() {
	...
	gulp.watch(paths.src + 'img/**/*.{jpg,jpeg,png,svg, webp}', images)
...
exports.build = gulp.series(
	clean,
	gulp.parallel(pug, lang, fonts, images, styles, stylesLibs, scripts, scriptsLibs)
)
